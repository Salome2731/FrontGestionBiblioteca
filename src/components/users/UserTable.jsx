        ...
        <div className="w-full overflow-x-auto rounded-lg border"
            ...
            <table className="w-full text-left">
                ...
                <tr className={styles.tableHeaderClass}>
                    ...
                    <th className={`${styles.cellClass} font-semibold whitespace-nowrap`}>DNI</th>
                ...
                {users && users.length > 0 ? (users.map((user, i) => (<tr key={i}>
                    <td className={styles.cellColor}>
                        <p className="font-semibold truncate pl-6">{user.firstName}</p>
                    </td>
                    <td className={styles.cellColor}>
                    ...
                    <td className={styles.cellColor}>
                        <p className="truncate text-xs sm:text-sm">{user.DNI || '-'}</p>
                    </td>
