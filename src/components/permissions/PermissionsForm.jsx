        ...
        <div>
            <form onSubmit={handleSubmit(onSubmit)} className={"text-left space-y-5"}>
                ...
                <div>
                    ...
                    <label htmlFor="module" className={styles.label}>Modulo <span className={"text-red-500"}>*</span></label>
                    <input
                        {...register("module", {
                            required: "El nombre es requerido",
                            minLength: {
                        ...
                        id={"module"}
                        type="text"
                        placeholder="Modulo del permiso"
                        className={`${styles.inputBase} ${errors.module ? styles.inputError : ""}`}
                    />
                    {errors.module && (
                        <span className={styles.errorText}>{errors.module.message}</span>
                    )}
                </div>
